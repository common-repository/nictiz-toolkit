...
add_action( 'kpb_get_widgets_list', array( 'Nictiz_Toolkit_Widget_Testimonials_Slider', 'register_block' ) );
	
class Nictiz_Toolkit_Widget_Testimonials_Slider extends Kopa_Widget {

	public $kpb_group = 'testimonial';
	
	public static function register_block( $blocks ) {
       	$blocks['Nictiz_Toolkit_Widget_Testimonials_Slider'] = new Nictiz_Toolkit_Widget_Testimonials_Slider();
        return $blocks;
    }
	...
	public function __construct() {
		...
		$this->widget_description = esc_html__( 'This widget displays testimonials in slider.', 'nictiz-toolkit' );
		$this->widget_id          = 'nictitate-toolkit-ii-widget-testimonials-slider';
		$this->widget_name        = esc_html__( '__Testimonials Slider', 'nictiz-toolkit' );
		$this->settings 		  = array(
			'title'  => array(
				'type'  => 'text',
				'std'   => '',
